...
**1120S family.** Three naming schemes and two gaps, established by
inventory: `{yy}co1120s{NN}.xls` in TY2004 (1120S Tables 1, 2, 4, 5, 6 only),
**nothing at all in TY2005**, and `{yy}co{NN}s.xls` for TY2006–2013 with
TY2008 shipping only Tables 7 and 8. So the balance-sheet pair runs 2006–2022
unbroken and the rest lose 2005 and 2008:

| Modern | Old 1120S table | Classifier | Status |
|---|---|---|---|
